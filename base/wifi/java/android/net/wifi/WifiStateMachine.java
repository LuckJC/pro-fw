...
public class WifiStateMachine extends StateMachine {
   ...
   /* Set the frequency band */
    ...
    /// M:For Passpoint R2@{
    private static final int M_CMD_ENABLE_HS                 = BASE + 196;
    private static final int M_CMD_FLUSH_BSS                 = BASE + 183;
    ...
    private final AtomicBoolean mHotknotConnected = new AtomicBoolean(false);
  ...
  //      Xlog.d(TAG, "setScanResults, scanResults:" + scanResults);
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case WifiManager.SET_WIFI_DISCONNECT:
                    loge("SET_WIFI_DISCONNECT trap at default state" + message);
                    if(message.arg1 == 1){
    ...
    class SupplicantStartedState extends State {
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                ///@}
                case M_CMD_ENABLE_HS:
                    ok = mWifiNative.enableHS(message.arg1 == 1);
                    log("enableHS, result = " + ok);
                    break;
                case M_CMD_FLUSH_BSS:
                    mWifiNative.bssFlush();
                    break;
    ...
    public boolean enableHS(boolean enabled) {
        ...
        sendMessage(M_CMD_ENABLE_HS, enabled ? 1 : 0   );
        return true;
    }
