...
class WifiApConfigStore extends StateMachine {
    ...
    private void setDefaultApConfiguration() {
        WifiConfiguration config = new WifiConfiguration();
        IWifiFwkExt wifiFwkExt = MediatekClassFactory.createInstance(IWifiFwkExt.class, mContext);
		...
		// modify by puyong@20140916 for Wi-Fi hotspot wifi网络使用不加密方式
		config.allowedKeyManagement.set(KeyMgmt.NONE);	// WPA2_PSK
