...
//            }
    ...
    private void handleKeyguardDoneDrawing() {
        synchronized(this) {
            ...
            } else if (mContext != null && mSystemReady && mBootCompleted) {
                /// M: Make sure "system ready" and "boot completed" before sending broadcast.
                // Otherwise, Java Exception will arise.
                mContext.sendBroadcast(new Intent(Intent.ACTION_SEND),
                        "com.android.internal.policy.impl.KeyguardViewMediator.DONE_DRAW");
            }
        }
    ...
    public void onBootCompleted() {
        /// M: Make sure the system is ready and boot is completed before sending broadcast
        mBootCompleted = true;
        if (mShowing) {
            mContext.sendBroadcast(new Intent(Intent.ACTION_SEND),
                    "com.android.internal.policy.impl.KeyguardViewMediator.DONE_DRAW");
