...
public class DatabaseHelper extends SQLiteOpenHelper {
       ...
       if (upgradeVersion == 51) {
        ...
        if (upgradeVersion == 55) {
            ...
            try {
                stmt = db.compileStatement("INSERT INTO system(name,value)"
                        + " VALUES(?,?);");
                //edit-s by leihai 2013/12/24 13:10:48 for install 
                /* original codes.
                loadSetting(stmt, Global.SET_INSTALL_LOCATION, 0);
                */
                loadSetting(stmt, Global.SET_INSTALL_LOCATION, 2);
                //edit-e by leihai 2013/12/24 13:10:48 for install 
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            /// M: Set for CT main sim selection settings:  //  CT_DATA_CONNECTION/def_ct_data_connection
            loadIntegerSetting(stmt, Settings.System.CT_MAIN_SIM_SELECTION, R.integer.def_ct_main_sim_selection);

            /// M: Set for CT time display mode
            loadIntegerSetting(stmt, Settings.System.CT_TIME_DISPLAY_MODE, R.integer.def_ct_time_display_mode);

            // set for sSurding dialing:
	    ...
	    loadSetting(stmt, Settings.System.TIME_12_24, "12"); // puyong for 12小时制
	    loadSetting(stmt, Settings.System.DATE_FORMAT, "EE-d-MMM-yyyy");// puyong for 日期格式修改
    ...
    private void loadSecureSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            Log.i(TAG, "IMEFeatureOption defaultIME : " + defaultIME);
            if (defaultIME != null) {
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadSetting(stmt, Settings.Global.DATA_ROAMING,
                    "true".equalsIgnoreCase(
                            SystemProperties.get("ro.com.android.dataroaming",
                                    String.valueOf(FeatureOption.MTK_CHIPTEST_INT))) ? 1 : 0);
            ...
            */
            loadSetting(stmt, Settings.Global.SET_INSTALL_LOCATION, 2);
            //edit-e by leihai 2013/12/24 13:10:48 for install 
           ...
           // end plugin set
           loadIntegerSetting(stmt, Settings.Global.WIFI_HOTSPOT_SUSPEND_OPTIMIZATIONS_ENABLED,
                   R.integer.wifi_hotspot_suspend_optimizations_enabled); 
           loadIntegerSetting(stmt, Settings.Global.WIFI_AP_OPERATIONAL_BAND,
                   R.integer.wifi_ap_operational_band); 
             // passpoint
