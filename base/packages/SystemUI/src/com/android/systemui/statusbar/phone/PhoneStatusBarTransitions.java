...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    public PhoneStatusBarTransitions(PhoneStatusBarView view) {
        super(view, R.drawable.system_bar_background);
        mView = view;
    ...
    public void init() {
        ...
        /// M: [ALPS01257009][KK] Support Battery Percentage for Low Profile Mode.
        mPercentage = mView.findViewById(R.id.percentage);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            mPercentage.setAlpha(newAlphaBC);
        }
    }
