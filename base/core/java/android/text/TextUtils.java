...
public class TextUtils {
   ...
   /**
    ...
    public static boolean isSurrogateChar(CharSequence text, int pos) {
        ...
        if (!isEmpty(text) && len >= 2) {
            final char prevChar = text.charAt(len - 2);
            final char currChar = text.charAt(len - 1);
   ...
   /**
    ...
    private static boolean DEBUG_LOG = SystemProperties.getBoolean("debug.text", false);
