...
public class ConnectivityManager {
    ...
    /** {@hide} */
    public static final int MAX_AOSP_NETWORK_TYPE = TYPE_MOBILE_IA;
    ...
    /** {@hide} */
    public static final int TYPE_CSD = 41;
    ...
    /** {@hide} */
    public static final int MAX_RADIO_TYPE   = TYPE_CSD;

    //MTK-START [mtk04070][111128][ALPS00093395]Replace TYPE_WIFI_P2P with TYPE_MOBILE_CMMAIL
    /** {@hide} */
    public static final int MAX_NETWORK_TYPE = TYPE_CSD;
    ...
    /**
     * Tethering dedicate APN Feature
     * @internal
    ...
    static public boolean isRadioNumValid(int radioNum){
        return radioNum >= PhoneConstants.GEMINI_SIM_1 && radioNum <= PhoneConstants.GEMINI_SIM_NUM;
    }
     ...
     * @internal
     * @param enable to set usb internet ON/OFF
     * @return true if success others are false
     * @hide
     */
    ...
    public void dialUpCsd(int slotId, String dialUpNumber) {
        try {
            mService.dialUpCsd(slotId, dialUpNumber);
            return;
        } catch (RemoteException e) {
            return;
        }
