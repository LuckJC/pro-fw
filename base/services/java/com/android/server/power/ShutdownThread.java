    ...
    static void shutdownInner(final Context context, boolean confirm) {
        ...
        final int resourceId = mRebootSafeMode
            ...
            : (longPressBehavior == 2
                    ...
                    //edit-s by leihai 2013/10/31 20:27:16 for reboot phone
                    /* original codes.
                    : com.android.internal.R.string.shutdown_confirm);
                    */
                    : (mReboot ? com.android.internal.R.string.reboot_confirm :
                        com.android.internal.R.string.shutdown_confirm));
                    //edit-e by leihai 2013/10/31 20:27:16 for reboot phone
    ...
    private static void beginShutdownSequence(Context context) {
        ...
        synchronized (mEnableAnimatingSync) {
            ...
            if(!mEnableAnimating) {
				...
				screenTurnOffTime=13000; // add by puyong@20140919 for 关机延时，让关机动画播放完成。
