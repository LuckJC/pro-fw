...
public final class BatteryService extends Binder {
    ...
    private int mLastBatteryStatus_2nd;
    private int mLastBatteryHealth;
    private boolean mLastBatteryPresent;
    private boolean mLastBatteryPresent_2nd;
    private int mLastBatteryLevel;
    private int mLastBatteryLevel_2nd;
    ...
    public int getBatteryLevel_2nd() {
        synchronized (mLock) {
            return mBatteryProps.batteryLevel_2nd;
        }
    }
    /**
    ...
    public boolean isBatteryLow_2nd() {
        synchronized (mLock) {
            return mBatteryProps.batteryPresent_2nd && mBatteryProps.batteryLevel_2nd <= mLowBatteryWarningLevel;
        }
    }
    /**
	...
	if (mLastBatteryVoltage != mBatteryProps.batteryVoltage) {
		Xlog.d(TAG, "mBatteryVoltage=" + mBatteryProps.batteryVoltage + ", batteryLevel=" + mBatteryProps.batteryLevel_2nd);		
	}
	...
	intent.putExtra(BatteryManager.EXTRA_STATUS_2ND, mBatteryProps.batteryStatus_2nd);
        intent.putExtra(BatteryManager.EXTRA_HEALTH, mBatteryProps.batteryHealth);
        intent.putExtra(BatteryManager.EXTRA_PRESENT, mBatteryProps.batteryPresent);
	intent.putExtra(BatteryManager.EXTRA_PRESENT_2ND, mBatteryProps.batteryPresent_2nd);
        intent.putExtra(BatteryManager.EXTRA_LEVEL, mBatteryProps.batteryLevel);
	intent.putExtra(BatteryManager.EXTRA_LEVEL_2ND, mBatteryProps.batteryLevel_2nd);
        ...
        if (DEBUG) {
			...
			", status_2nd:" + mBatteryProps.batteryStatus_2nd + ", present_2nd:" + 
                    mBatteryProps.batteryPresent_2nd + ",level_2nd:" + mBatteryProps.batteryLevel_2nd);
        }
    ...
    protected void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
		...
		pw.println("  status: " + mBatteryProps.batteryStatus_2nd);
                pw.println("  health: " + mBatteryProps.batteryHealth);
                pw.println("  present: " + mBatteryProps.batteryPresent);
		pw.println("  present: " + mBatteryProps.batteryPresent_2nd);
                pw.println("  level: " + mBatteryProps.batteryLevel);
		pw.println("  level: " + mBatteryProps.batteryLevel_2nd);
			...
			} else if ("status_2nd".equals(key)) {
                        	mBatteryProps.batteryStatus_2nd = Integer.parseInt(value);
                    } else if ("level".equals(key)) {
                        mBatteryProps.batteryLevel = Integer.parseInt(value);
				 } else if ("level_2nd".equals(key)) {
                        		mBatteryProps.batteryLevel_2nd = Integer.parseInt(value);
    ...
    private final class Led {
        ...
        public void updateLightsLocked() {
            ...
            if (level < 3) {//mLowBatteryWarningLevel gongjh charge
