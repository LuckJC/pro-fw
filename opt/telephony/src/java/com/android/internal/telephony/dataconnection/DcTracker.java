    ...
    protected void onDataSetupComplete(AsyncResult ar) {
        ...
        if (ar.exception == null) {
            ...
            if (dcac == null) {
                ...
                // M: if setup success, can cancel the reconnectAlarm
                if ((apnContext != null) && (apnContext.getReconnectIntent() != null)){
                    log("onDataSetupComplete: success, so cancel the reconnectAlarm for type:" + apnContext.getApnType());
                    cancelReconnectAlarm(apnContext);
                }
