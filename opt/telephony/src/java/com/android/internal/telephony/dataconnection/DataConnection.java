...
public final class DataConnection extends StateMachine {
    ...
    static {
        ...
        sCmdToString[EVENT_DATA_CONNECTION_DRS_OR_RAT_CHANGED - BASE]= "EVENT_DATA_CONNECTION_DRS_OR_RAT_CHANGED";
    }
    ...
    private DataConnection(PhoneBase phone, String name, int id,
        ...
        //[SM_CAUSE]
        try{
            mGsmDCTExt = MediatekClassFactory.createInstance(IGsmDCTExt.class, mPhone.getContext());
        } catch (Exception e){
    ...
    //[mr2] added , this part was in GsmDataConnection at mr1
    /**
    ...
    private void clearSettings() {
        ...
        //SM_CAUSE: special case for prevent count reset by lost connection
    ...
    private boolean initConnection(ConnectionParams cp) {
        ...
        if (mApnSetting == null) {
            ...
            if (mApnSetting == null) {
                if (DBG) log("Get null apnSetting from ConnectionParams cp=" + cp
    ...
    private class DcDefaultState extends State {
        ...
        public void enter() {
            ...
            //[KK] added: Register for DRS or RAT change
            ...
            switch (msg.what) {
                ...
                case EVENT_DATA_CONNECTION_DRS_OR_RAT_CHANGED:
                    ...
                    if ((rat == mRilRat) && (drs == mDataRegState)) {
                        ...
                        if (mGsmDCTExt.needSmRetry(mDcFailCause)){
                            //M: SM_CAUSE
                            if (DBG) {
                                log("DcRetryingState: EVENT_DATA_CONNECTION_DRS_OR_RAT_CHANGED"
            ...
            switch (msg.what) {
                ...
                case EVENT_GET_LAST_FAIL_DONE:
                    ...
                    if (cp.mTag == mTag) {
                        ...
                        if (mGsmDCTExt.needSmRetry(cause)){
                        ...
                        if (cause.isRestartRadioFail()) {
                            ...
                            transitionTo(mInactiveState); 
                        } else if (mGsmDCTExt.needSmRetry(cause)) {
                            //[SM_CAUSE]
                            ...
                            if (mRetryManager.isRetryNeeded()){
                                ...
                                if (DBG) log("SM_CAUSE no retry because exceed retry count");
                                mInactiveState.setEnterNotificationParams(cp, cause);
                                transitionTo(mInactiveState);
                            }
